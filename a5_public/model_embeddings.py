...
class ModelEmbeddings(nn.Module):
    ...
    def __init__(self, embed_size, vocab):
        ...
        char_emb_size = 50
        self.char_embedding = nn.Embedding(len(vocab.char2id), char_emb_size, pad_token_idx)
        self.convNN = CNN(f=self.embed_size)
        self.HighwayNN = Highway(emb_size=self.embed_size)
    ...
    def forward(self, input):
        ...
        for x_padded in input:
            ...
            x_highway = self.HighwayNN(x_conv_out)
