...
class NMT(nn.Module):
    ...
    def __init__(self, embed_size, hidden_size, vocab, dropout_rate=0.2):
        ...
        self.encoder = nn.LSTM(embed_size, self.hidden_size, bidirectional=True, dropout_rate=self.dropout_rate)
        self.decoder = nn.LSTM(self.hidden_size + embed_size, self.hidden_size, bias=True)
    ...
    def encode(self, source_padded: torch.Tensor, source_lengths: List[int]) -> Tuple[
        ...
        enc_hiddens, _ = pad_packed_sequence(X)
